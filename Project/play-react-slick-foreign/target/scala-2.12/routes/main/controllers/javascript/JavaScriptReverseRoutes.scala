...
package controllers.javascript {
  ...
  class ReverseProductController(_prefix: => String) {
    ...
    // @LINE:10
    def getByCategories: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.ProductController.getByCategories",
      """
        function() {
    ...
    // @LINE:11
    def handlePost: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.ProductController.handlePost",
      """
        function() {
          return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "handlepost"})
        }
      """
    )
    ...
    def getByCategory: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(id0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "category/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[Integer]].javascriptUnbind + """)("id", id0))})
        }
      """
    )
